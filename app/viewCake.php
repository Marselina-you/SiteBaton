...
<body>
	...
	<div class="container-fluid assortiment-container">
		<div class="wrap-assortiment-container d-flex flex-column">
			<div class="assortiment-container__title d-flex justify-content-center"><div class="lightbrowncolor size45px fontTahoma text-center font-weight-bold col-lg-6 padding25">ПИРОЖНЫЕ</div></div>
...
// Возьмите данные профиля из базы данных
 $select = $son->query("SELECT  foto, name, description, ingredient1, ingredient2, ingredient3, value, nal, slogan, t1, t2, t3  FROM ass WHERE types = 'пирожные' LIMIT 180");
