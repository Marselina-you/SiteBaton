...
<body>
	...
	<div class="container-fluid assortiment-container">
		<div class="wrap-assortiment-container d-flex flex-column">
			<div class="assortiment-container__title d-flex justify-content-center"><div class="lightbrowncolor size45px fontTahoma text-center font-weight-bold col-lg-6 padding25">БЕЛАЯ ВЫПЕЧКА</div></div>
